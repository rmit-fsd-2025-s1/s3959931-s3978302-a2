...
import { CourseWithDetails, getCoursesWithDetails } from "../../utils/coursesUtils";
...
const TutorPage: React.FC = () => {
    ...
    const filteredCourses = React.useMemo(() => {
        return courses.filter((course) => {
            ...
            const matchesCategory = !selectedCategory || course.code.startsWith(selectedCategory);
    ...
    }, [courses, searchQuery, selectedCategory, activeFilter, existingApplications]);
    ...
    const handleSubmitApplication = (applicationData: TutorApplication) => {
        ...
        try {
            ...
            setExistingApplications([...existingApplications, applicationData.courses[0]]);
    ...
    return (
        <Layout>
            ...
            {/* Hero Section */}
            <motion.div className="tutor-hero-section" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6 }}>
                <div className="tutor-hero-content">
                    <motion.h1
                        ...
                        Find Your Perfect <span className="hero-highlight">Teaching</span> Opportunity
                    </motion.h1>
                    <motion.p
                        ...
                        Browse available courses and apply for tutor or lab-assistant positions with the School of Computer Science
                    </motion.p>
                    ...
                    <motion.div
                        ...
                        <div className="stat-item">
                            <div className="stat-value">{existingApplications.length}</div>
                            <div className="stat-label">Your Applications</div>
                        </div>
                        <div className="stat-divider"></div>
                        <div className="stat-item">
                            <div className="stat-value">{courses.length - existingApplications.length}</div>
            ...
            <div className="tutor-container">
                ...
                <motion.div
                    ...
                    <div className="filter-pills">
                        ...
                        <button
                            className={`filter-pill ${activeFilter === "available" ? "active" : ""}`}
                            onClick={() => setActiveFilter("available")}>
                            Available
                        </button>
                        <button className={`filter-pill ${activeFilter === "applied" ? "active" : ""}`} onClick={() => setActiveFilter("applied")}>
                            Applied
                        </button>
                    </div>
                    ...
                    <div className="category-filters">
                        <button className={`category-pill ${!selectedCategory ? "active" : ""}`} onClick={() => setSelectedCategory(null)}>
                            All
                        </button>
                    ...
                    <motion.div className="courses-grid" variants={containerVariants} initial="hidden" animate="visible">
                        {filteredCourses.map((course, index) => (
                            <motion.div
                                ...
                                <CourseCard course={course} openApplyModal={openApplyModal} hasApplied={existingApplications.includes(course.code)} />
                            </motion.div>
                        ))}
                    </motion.div>
                ) : (
                    <div className="no-courses">
                        <Image src="/empty-box.svg" alt="No courses found" width={150} height={150} />
